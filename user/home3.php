            ...
            <table class="table table-striped text-center" style="max-width: 100%;">
              <thead>
                <tr>
                  ...
                  <th>Ruang</th>
                  <th>Status</th>
                  <th colspan="4">Detail Pinjaman</th>
                </tr>
              </thead>
              <tbody>
                <?php 
                  ...
                  $query = "SELECT *, `peminjaman2`.`id` AS `pinjam`, `penanggungjawab`.`nama` AS 'Penanggungjawab', `ruang`.`nama` AS 'Ruang', `status`.`status` AS 'Status' FROM `peminjaman2` JOIN `penanggungjawab` ON `peminjaman2`.`id_penanggungjawab`=`penanggungjawab`.`id` JOIN `ruang` ON `peminjaman2`.`id_ruang`=`ruang`.`id` JOIN `status` ON `peminjaman2`.`id_status`=`status`.`id` WHERE `penanggungjawab`.`id` = '$sesi'" ;
                ...
                <tr>
                  ...
                  <td class="border-right-0 align-middle">
                    <form method="post" action="batal.php">
                      <input type="hidden" name="id-pinjam" value="<?=$data['pinjam']?>">
                      <input class="btn btn-danger" type="submit" name="Batal" value="Batal">
                      <!-- <a class="btn btn-primary" href="edit.php" role="button">Edit</a> -->
                    </form>
                  </td>
                </tr>
              ...
              <?php
                  ...
                  <tr>
                  <form action="form.php">
                    <td class="text-center" colspan="11"><button class="btn btn-primary" action="form.php">Tambah Data</button></td>
                  </form>
                </tr>
                  <?php
                }
      ...
      <div class="row align-items-center">
        ...
        <div class="col-md-4">
          <ul class="list-inline social-buttons">
            ...
            <li class="list-inline-item">
              <a href="https://www.facebook.com/museumsandi">
                <i class="fab fa-facebook-f"></i>
              </a>
            </li>
            <li class="list-inline-item">
              <a href="https://twitter.com/museumsandiina">
